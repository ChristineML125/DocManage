...
import '../../component/dashboard-page/staff-upload.js';

export class DocUpload extends LitElement {
    static styles = css`
    :host{
        display: block;
        height: 100vh;
        ...
        <div class="layout">
            ...
            <div class="top">
                ...
                <div class="scroll-area">
                    <staff-upload-page></staff-upload-page>
                </div>   
            </div>
        </div>
        `;
...
customElements.define('upload-page', DocUpload);
