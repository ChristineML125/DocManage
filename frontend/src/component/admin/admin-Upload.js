...
export class AdminUpload extends LitElement {
  static properties = {
    ...
    showModalCategory: { type: Boolean },
    showModalDepartment: { type: Boolean },
  ...
  renderSuccessView() {
    return html`
      ...
      <div class="actions-row">
        <button class="btn btn-primary" @click=${() => Router.go('/allDocument')}>
        ...
        <div class="bento-card">
          ...
          <div class="form-group">
            ...
            <div class="category-row">
              ...
              <button class="icon-btn" type="button" title="Create category" @click=${this.openModalCategory}>
          ...
          <div class="form-group">
            ...
            >
              ...
              <button class="icon-btn" type="button" title="Create department" @click=${this.openModalDepartment}>
                <span class="material-symbols-outlined">add</span>
              </button>
          </div>
          </div>
        ...
        <div class="modal-backdrop" @click=${this.closeModal}>
          <div class="modal" @click=${(e) => e.stopPropagation()}>
            ...
            <div class="modal-actions">
              ...
              <button class="btn-save" type="button" @click=${this.handleCreateCategory}>Save Category</button>
            </div>
          </div>
        </div>
      ` : this.showModalDepartment ? html`
        <div class="modal-backdrop" @click=${this.closeModal}>
          <div class="modal" @click=${(e) => e.stopPropagation()}>
            ...
            <div class="modal-actions">
              <button class="btn-cancel" type="button" @click=${this.closeModal}>Cancel</button>
              <button class="btn-save" type="button" @click=${this.handleCreateDepartment}>Save Department</button>
            </div>
          </div>
        </div>
        ` : ``}
