...
export class TopBar extends LitElement {
  ...
  async _handleSearch(){
    ...
    console.log('🔍 Search triggered with keyword:', this.searchValue);
    Router.go(`/admin-allDocument?keyword=${encodeURIComponent(this.searchValue)}`);
...
customElements.define('admin-top-bar', TopBar);
