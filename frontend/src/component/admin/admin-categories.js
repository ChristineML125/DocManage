...
export class AdminCategories extends LitElement {
    static properties = {
        ...
        modalType: {type: String}  // 'category' or 'department'
    }
    ...
    constructor() {
        ...
        this.modalType = 'category';  // Default to category modal
    }
        ...
        : this.categories.map(cat => html`
          <div class="category-card">
            <div class="card-header">
              ...
              <button class="icon-btn" @click=${() => this.handleCategoryDelete(cat.id)}>
