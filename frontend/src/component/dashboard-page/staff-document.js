...
export class StaffAllDocument extends LitElement {
 ...
 static styles = css`
    ...
    @media (max-width: 767px) {
        ...
        .mobile-preview-btn.active { background: #00685f; color: #fff; border-color: #00685f; }
    }
  `;
...
customElements.define('staff-document-page', StaffAllDocument);
